...
class _CommentsItemState extends State<CommentsItem> {
  ...
  replyCommentScreen() async {
    var count = await Navigator.of(context).pushNamed(
       
      Routes.videoCommentsReply,
      arguments: //CommentsArguement(
        {
           "item": widget.object, "repliesCount": widget.object.replies
        });
      ...
      child: Container(
        ...
        child: IntrinsicHeight(
          ...
          child: Row(
            ...
            children: <Widget>[
              widget.object.profile.toString() == ""
                  ? CircleAvatar(
                  ...
                  : Card(
                      ...
                      child: Container(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: widget.object.profile!.toString(),
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      //  Utility.getBase64DecodedString(widget.object.content!),
                            widget.object.content!.toString(),
                          maxLines: 10,
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Visibility(
                              visible: context.read<UserDetailsCubit>().getUserEmail() == widget.object.email? true : false,
                              child: InkWell(
