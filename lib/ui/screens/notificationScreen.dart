...
import 'package:bevicschurch/features/notificatiion/cubit/notificationCubit.dart'; 
import 'package:bevicschurch/ui/widgets/circularProgressContainner.dart';
import 'package:bevicschurch/ui/widgets/customListTile.dart';
                    ...
                    builder: (context, state) {
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return hasMore && index == (notificationList
                                .length - 1)
                                ? Center(
