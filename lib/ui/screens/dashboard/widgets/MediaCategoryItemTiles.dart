...
class MediaCategoryItemTiles extends StatefulWidget {
  final MediaPlayerModel object;
  final List<MediaPlayerModel> mediaList;
  final int index;

  const MediaCategoryItemTiles({
    Key? key,
  ...
  @override
  _MediaCategoryItemTilesState createState() => _MediaCategoryItemTilesState();
  
}

class _MediaCategoryItemTilesState extends State<MediaCategoryItemTiles> {
  @override
