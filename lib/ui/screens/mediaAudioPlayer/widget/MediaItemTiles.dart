...
class MediaItemTiles extends StatefulWidget {
  ...
  @override
  _MediaItemTilesState createState() => _MediaItemTilesState();
  
}

class _MediaItemTilesState extends State<MediaItemTiles> {
