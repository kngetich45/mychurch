class BibleModel {
  ...
  factory BibleModel.fromJson(Map<String, dynamic> json, String? version) {
    //print(json);
  ...
  factory BibleModel.fromMap(Map<String, dynamic> data) {
    return BibleModel(
      id: data['id'],
      book: data['book'],
  ...
  factory BibleModel.fromCOloredMap(Map<String, dynamic> data) {
    return BibleModel(
      id: data['id'],
      book: data['book'],
      chapter: data['chapter'],
