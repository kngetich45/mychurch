...
class Downloads {
  ...
  static mapCurrentDownloadMedia(MediaPlayerModel media) {
    return Downloads(
      id: media.id,
  ...
  static MediaPlayerModel mapMediaFromDownload(Downloads media) {
