...
class ProfileManagementLocalDataSource {
  ...
  String getIsPremier() {
    return Hive.box(userdetailsBox).get(isPremierBoxKey, defaultValue: "");
  }
  ...
  Future<void> setFirebaseId(String firebaseId) async {
   ...
   Future<void> setIsPremier(String isPremier) async {
    Hive.box(userdetailsBox).put(isPremierBoxKey, isPremier);
  }
