import 'package:bevicschurch/features/wallet/models/payoutMethod.dart';

final String appName = "I Love My Church";
final String packageName = "com.bevics.church";
 
final List<String> supporatedLocales = ['en'];
//
final String defaultLanguageCode = 'en';

//Enter 2 Letter ISO Code of country
//It will be use for phone auth.
final String initialSelectedCountryCode = 'KE';
...
final String isPremierBoxKey = "isPremier";
...
//chats
final String resentChatsKey = "resentChats";
...
final String categoryImage = databaseUrl +'/images/category/';
final String profileImage = databaseUrl +'/images/profile/';
//lifelines
...
//bible
final String getmedia = "${baseUrl}get_media_data";
final String getmediabyCategoryId = "${baseUrl}get_media_by_categoryId_data";


final String getDashboardCategoryUrl = "${baseUrl}get_dashboard_category_data";
final String deletecomment = "${baseUrl}destroy_comment_by_id";
final String makecomment = "${baseUrl}make_comments_data";
final String getcomments = "${baseUrl}get_comments_results";
final String editcomment = "${baseUrl}edit_comments_by_id";
final String reportcomment = "${baseUrl}resport_comments_data";

final String loadreplies = "${baseUrl}get_replies_data";
final String replycomment = "${baseUrl}reply_comments_data";
final String deletereply = "${baseUrl}delete_reply_data";
final String editreply = "${baseUrl}edit_reply_data"; 

final String likeunlikemedia = "${baseUrl}like_unlike_media_data";
final String updateMediaTotalViews = "${baseUrl}update_media_total_views";
final String getmediatotallikesandcommentsviews = "${baseUrl}get_media_total_likes_and_comments_views";
 
final String getHmnsList = "${baseUrl}get_hmns_data";
final String getHmnsCatList = "${baseUrl}get_hmns_category_data";

final String getGivingList = "${baseUrl}get_giving_data";
final String getGivingCatList = "${baseUrl}get_giving_category_data";

final String getStreamingList = "${baseUrl}get_streaming_data"; 

final String getDevotionalsList = "${baseUrl}get_devotionals_data";
final String getEventList = "${baseUrl}get_events_data";
final String getBibleVerse = "${baseUrl}get_bible_versions_data";

//chat
final String getChatUsersList = "${baseUrl}get_chat_users_data";
